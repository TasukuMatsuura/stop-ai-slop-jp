...
description: 日本語の文章からAI臭を取り除く。下書き、編集、レビューのときに使う。表層のクセ(全角ダッシュ、偏愛語)も、構造のクセ(false agency、必殺技造語、命題型H2、伝聞口調の欠落、両論併記、書き手の不在)も扱う。
metadata:
  trigger: 日本語のプロセス、編集、レビュー、AI臭の検出と修正
  language: ja
...
予測可能なAI文章パターンを日本語から取り除く。

## 大原則

AI臭の正体は、書き手の不在だ。自分が何を経験して、どう考えて、どう拙い言葉で人に伝えようとしているのか、そのコアをAIに委ねると臭う。全角ダッシュや偏愛語は、その表面に現れるクセでしかない。
...
ここに答えられないなら、表面修正は後回しでいい。先に「自分は何が言いたいのか」を固める。
...
5. **遠くから語らない**。「人々は〜する傾向にある」「現代社会において」をやめ、「自分は」「あなたは」で書く。
...
書き終わったら、上から順に確認する。何より音読が効く。目で読むと気付かない違和感が、口に出すと一気に出てくる。
